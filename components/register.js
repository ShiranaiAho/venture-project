          ...
          <form className="flex flex-col">
            {page === 1 ?
              <div className="flex flex-col p-5">
                ...
                <input onChange={({ target }) => handleChange(target, 'tel')} required className="rounded-lg bg-gray-900 border-2 h-9 mb-5" />
                <button 
            ...
            {page === 2 ?
              <div className="flex flex-col p-5">
                <label>CEP</label>
                <input onChange={({ target }) => handleChange(target, 'cep')} required className="rounded-lg bg-gray-900 border-2 h-9 mb-5" />
            ...
            {page === 3 ?
              <div className="flex flex-col p-5">
                ...
                <label>CPF</label>
                <input onChange={({ target }) => handleChange(target, 'cpf')} required className="rounded-lg bg-gray-900 border-2 h-9 mb-5" />

                <label>Renda Mensal</label>
                <input onChange={({ target }) => handleChange(target, 'monthlyIncome')} required className="rounded-lg bg-gray-900 border-2 h-9 mb-5" />
                <button 
                  className="bg-purple-700 py-5 font-bold rounded-lg mt-48 hover:bg-purple-500"
